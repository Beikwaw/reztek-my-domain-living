...
export default function AdminMaintenance() {
  ...
  const exportToPDF = async () => {
    try {
      ...
      // Improved mobile PDF handling
      const isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);
      const fileName = `my_domain_${activeTab.toLowerCase()}_maintenance_${format(new Date(), "yyyy-MM-dd")}.pdf`;
      
      if (isMobile) {
        try {
          // For mobile: First try using the download attribute with data URI
          // This works on modern mobile browsers
          ...
          // Create an invisible button and add it to the DOM
          ...
          alert("Your download should begin shortly. If it doesn't appear in your downloads, check your browser settings.");
        } catch (mobileError) {
